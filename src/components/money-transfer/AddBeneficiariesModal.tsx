      ...
      <SmartModal.Body className="flex justify-center">
        ...
        >
            ...
            rules={[
              ...
              ({ getFieldValue }) => ({
                validator(_, value) {
                  if (
                    !value ||
                    value === getFieldValue("beneficiaryAccountNo")
                  ) {
          ...
          <Form.Item
            ...
            className="w-[444px]"
          >
            <Input placeholder="Enter Bank Name" className="h-[39px]" />
          </Form.Item>
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter IFSC Code" },
              {
                ...
                message: "Enter valid IFSC (e.g., HDFC0001234)",
              },
            ]}
            className="w-[444px]"
          >
            <Input placeholder="Enter IFSC Code" className="h-[39px]" />
          </Form.Item>
          ...
          <Form.Item
            ...
            className="w-[444px]"
          >
            <Input placeholder="Enter Address" className="h-[39px]" />
          </Form.Item>
          ...
          <Form.Item
            ...
            className="w-[444px]"
          >
            <Input placeholder="Enter Beneficiary Name" className="h-[39px]" />
          </Form.Item>

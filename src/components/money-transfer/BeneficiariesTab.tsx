...
import {
    ...
    type Beneficiary,
    type Sender,
} from "@/features/retailer/dmt/sender";
        ...
        <>
                ...
                header={
                    <div className="flex items-start justify-between">
                        ...
                        <Button
                            ...
                            disabled={!sender_id} // need a sender to add beneficiary
                        >
                            Add Beneficiary
                        </Button>
                    </div>
                    ...
                    <>
                        ...
                        <CardLayout
                            ...
                            body={
                                <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
                                    ...
                                    <StatCard title="Remaining Limit" value={availableLimit} icon={<ReloadOutlined />} />
                                </div>
                            }
                        />
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
                            {(beneficiaries ?? []).map((b) => {
                                ...
                                return <BeneficiaryCard key={beneficiary_id} b={b} onSendCLick={onSendCLick} />;
                            })}
                        </div>
                    </>
                }
            ...
            {isAddOpen && sender_id && (
                <AddBeneficiariesModal
                    open={isAddOpen}
                    onClose={handleModalClose} // refresh on close
...
function BeneficiaryCard({
    ...
    const { b_mobile, b_name, bankname, lastfour } = b || {};
    return (
        <CardLayout
            ...
            header={
                <div className="flex items-center gap-3">
                    <Avatar size={44} icon={<UserOutlined />} className="!bg-[#EEF3FF] !text-[#3B82F6]" />
                    <div className="min-w-0">
                        <div className="truncate text-[14px] font-semibold text-gray-900">{b_name}</div>
                ...
                <div className="mt-3 space-y-2">
                    ...
                    <div className="mt-3 flex items-center gap-2">
                        <Button
                            ...
                            onClick={() => onSendCLick?.(b)} // <-- invoke callback with beneficiary
                        >
                            Send
                        </Button>

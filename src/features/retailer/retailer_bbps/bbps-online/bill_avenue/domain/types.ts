...
export const BACustomerInfoSchema = z
  .object({
    customerMobile: z.string(),
    customerEmail: z.string().email().optional(),
    customerAdhaar: z.string().optional(),
    customerName: z.string().optional(), // optional in some BillAvenue payloads
    customerPan: z.string().optional(), // Server may enforce if amount > 49,999
  })
  .strict();
...
export const BABillerResponseSchema = z
  .object({
...
/** Amount info */
export const BAAmountInfoSchema = z
  .object({
...
export const CustomerInfoSchema = z
  .object({
    ...
    customerAdhaar: z
      .string()
      .regex(/^\d{12}$/, "customerAdhaar must be 12 digits")
      .optional(),
...
export const InputParamEntrySchema = z
  .object({
...
export const BillerResponseSchema = z
  .object({
...
export const AmountInfoSchema = z
  .object({
 ...
 */
const PaymentInfoInnerSchema = z
  .object({
...
export const AdditionalInfoItemSchema = z
  .object({
    infoName: z.string().min(1),
    infoValue: z.string().min(1),
  })
...
export const AdditionalInfoSchema = z.union([
  z.object({ info: AdditionalInfoItemSchema }).strict(),           // single object
  z.object({ info: z.array(AdditionalInfoItemSchema) }).strict(),  // array of objects
]);
export type AdditionalInfo = z.infer<typeof AdditionalInfoSchema>;

/** Request body */
export const BillPaymentRequestSchema = z
  .object({
...
/** Response — resilient */
export const BillPaymentResponseDataSchema = z
  .object({
...
export const BillPaymentResponseSchema = z
  .object({
...
/* ======================================================================
 * Complaint Tracking
 * POST /secure/bbps/bbps-online/bills/track-complaint/{tenantId}

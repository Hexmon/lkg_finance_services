...
const p = {
  ...
  sendOtp: '/auth/user-onboarding/mobile-email-verification/send-otp',
  emailOtpGenerate: '/auth/user-onboarding/mobile-email-verification/generate-email-otp',
  emailOtpVerify: '/auth/user-onboarding/mobile-email-verification/verify-mobile-email-otp',
  aadhaarOtpGenerate: '/auth/user-onboarding/kyc/aadhaar-otp-generate',
  aadhaarOtpVerify: '/auth/user-onboarding/kyc/aadhaar-otp-verify',
  panVerify: '/auth/user-onboarding/kyc/pan-verify',
  register: '/auth/user-onboarding/register',

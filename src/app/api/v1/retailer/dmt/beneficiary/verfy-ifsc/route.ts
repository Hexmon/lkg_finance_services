...
/**
 * BFF: POST /api/v1/retailer/dmt/beneficiary/verify-ifsc
 * Proxies upstream:
...
export async function POST(req: NextRequest) {
    ...
    // ---- Proxy upstream ----
    try {
        const url = RETAILER_ENDPOINTS.DMT.BENEFICIARIES.VERIFY_IFSC;
        ...
        // Accept either envelope and normalize
        ...
        return NextResponse.json(err?.data ?? { error: err.message }, { status });
    }
}

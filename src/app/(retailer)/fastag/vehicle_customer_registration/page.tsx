...
export default function FastTagVehicleDetailsPage() {
  return (
    <DashboardLayout
          ...
          <Card className="w-full min-h-[339px] rounded-[15px] bg-white shadow-sm p-6">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div>
                ...
                <Input
                  placeholder="Enter VIN Number / Chassis Number"
                  className="!h-[42px] rounded-md bg-[#F5F5F5] border-none"
                />
              </div>
            </div>
            ...
            <div className="flex justify-center mt-10">
              <Button
                type="default"
                className="!bg-[#5298FF54] !text-[#3386FF] !rounded-lg !h-[42px] !font-medium !w-[445px] hover:!bg-[#E2E8F0]"
              >
                Continue to KYC
              </Button>
            </div>

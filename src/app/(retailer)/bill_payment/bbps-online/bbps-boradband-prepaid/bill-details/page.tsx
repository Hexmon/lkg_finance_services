...
export default function BillDetailsPage() {
  ...
  return (
    <DashboardLayout activePath="/bill_details" sections={billPaymentSidebarConfig} pageTitle="Bill Details">
      <div className="min-h-screen w-full mb-3">
        <div className="flex justify-between items-center">
          <DashboardSectionHeader
            title="Moblie Prepaid"
          ...
          <div className="bg-white p-6 rounded-2xl shadow-md w-full max-w-full space-y-4 relative">
            ...
            <div className="bg-[#FFFFFF] p-6 rounded-xl shadow-md">
              ...
              <div className="flex flex-col md:flex-row gap-8 mt-6">
                ...
                onClick={() => router.push("/bill_payment/bbps-online/bbps-boradband-prepaid/payment")}
                >
                  Pay ₹70692
                </Button>
              </div>

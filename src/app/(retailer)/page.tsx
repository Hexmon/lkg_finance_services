...
export default function Dashboard() {
  const { data: { quick_links, balances: { MAIN, AEPS } = {}, commissions, name, profile, transactions: { success_rate = 0, growth, overall_transaction, success_rate_ratio = 0, total_transaction: { ratio: totalTxnRatio = 0,total_count: totalTxnCount =0 ,last_month_ratio: txnMontRatio = 0 } = {} } = {}, user_id, username, virtual_account, customers: {total_users_count} = {} } = DEFAULT_DASHBOARD ?? {}, isFetching, isPending, isPlaceholderData, error: dashboardError } = useRetailerDashboardQuery();
  ...
  return (
    ...
    >
      ...
      <Feature commissions={commissions} success_rate={success_rate} success_rate_ratio={success_rate_ratio} totalTxnCount={totalTxnCount} totalTxnRatio={totalTxnRatio} total_users_count={total_users_count ?? 0} customerLastMonthCount={0} transactionLatMontRatio={0} />

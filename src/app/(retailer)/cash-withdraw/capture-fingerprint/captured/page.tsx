                ...
                <Card className="rounded-2xl shadow-md">
                    ...
                    <div className="text-center my-6 flex flex-col justify-center items-center">
                        <Image
                            ...
                            className="object-contain "
                        />
                        <div className="!mb-2 !text-black !font-poppins !text-[15px] font-[450]">Fingerprint Captured
                            <CheckOutlined className="text-black text-[18px] !ml-2 font-[450]" />
                        </div>
                        <Text className="secondary !mt-0 !mb-5 !text-[10px] font-semibold !text-[#9A9595]">Customer fingerprint has been successfully captured
                        </Text>
